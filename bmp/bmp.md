...
|biCompression|001Eh|4 bytes|说明图像压缩的类型，-0 BI_RGB 不压缩-1 BI_BLE8 8比特游程编码，只用于8位位图-2 BI_BLE4 4比特游程编码，只适用于4位位图-3 BI_BITFIELDS 比特域，用于16/32位位图-4 BI_JPEG JPEG位图含JPEG图像-5 BI_PNG PNG 位图含PNG图像|
